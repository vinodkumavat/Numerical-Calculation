...
# Updating the variables after one variable get updated
# same as JAcobi just updating after any of variable changes here
...
def equation(X, Y, Result):
    for i in range(len(Y)):
        ...
        # Updating after each variable and storing as array
        Result[i] = (Y[i] - sum_)/X[i][i]
    return Result
